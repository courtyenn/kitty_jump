...
var kitty_jump = (function(){
	...
	var Okibble = true;
	var bgSound = new Audio('sound/meowmix.mp3');
	var gameSound = new Audio('sound/monkeyspinning.mp3');
	var soundFx = new Audio('sound/catmeow.mp3');
	var gameDead = new Audio('sound/catscream.mp3');
	var enemy = new Image();
	var enemies = [];
	var playerBullets = [];
	var player = {
	...
	(function(){
		//console.log('PRELOAD');
		player.image.src = "images/kitty_eat.png";
		enemy.src = "images/candy_sm.png";
		player.lives.image.src = "images/life.png";
		kibble_O.src = "images/kibble_O.png";
		kibble_X.src = "images/kibble_X.png";
		//console.log('done');
	})();
